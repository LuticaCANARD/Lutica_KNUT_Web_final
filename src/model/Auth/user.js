 ...
 */
export const insertUserTable = async (loginId,email,hashedPassword) => {
	const res = await db.query("INSERT INTO user (loginId,password,email) VALUES (?,?,?) ",[loginId,hashedPassword,email]);
